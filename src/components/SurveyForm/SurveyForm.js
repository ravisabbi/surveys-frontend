...
function Survey() {
      ...
      >
        {({ isSubmitting }) => (
          <Form className="survey-form-container">
            ...
            {showErrMsg ? <p className="survey-form-error-msg">{errorMsg}</p> :<p className="survey-form-error-msg">{}</p>}
            </div>
  ...
  <div className="survey-completed-view-container">
   <h1 className="survey-completed-view-heading" >Sorry! You have no survey yet</h1>
   <p className="survey-completed-caption" >You can close your browser</p>
  </div>);
  ...
  return (
    ...
    //           ))}
    //         </ul>
    //         {showErrMsg && <p className="survey-form-error-msg">{errorMsg}</p>}
    //         <div className="survey-button-container">
    //           <button
    //             type="button"
    //             onClick={handleNext}
